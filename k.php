...
<form name="form1" method="post" action=""  id="form1" enctype="multipart/form-data">
    ...
    <table width="100%">
        ...
        <br />
            ...
            <td width="50%"
                valign="top"><span class="c4">
        <textarea id="emaillist" class="validate[required]" name="emaillist" cols="50" rows="10" placeholder="Emails go here, one email at a line">karim.dallas07@gmail.com</textarea>
        </span></td>
        </tr>
        <tr>
            <td width="5%"
